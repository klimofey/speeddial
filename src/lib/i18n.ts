...
const de: Dict = {
  ...
  onb_welcome_title: 'Willkommen bei Dialy', onb_welcome_body: 'Ein sauberer, privater neuer Tab – keine Werbung, kein Tracking. Alles bleibt auf deinem Gerät.', onb_footer_title: 'Chrome-Leiste unten ausblenden', onb_footer_body: 'Chrome zeigt unten eine eigene Leiste. So blendest du sie aus: „Customize Chrome“ (unten rechts) → Footer → „Show footer on New Tab page“ deaktivieren.', onb_start_title: 'Mach ihn zu deinem', onb_start_body: 'Mit + fügst du Seiten und Widgets hinzu, mit „Bearbeiten“ verschiebst und skalierst du, und im ⚙-Menü findest du Designs und Einstellungen.', onb_skip: 'Überspringen', onb_back: 'Zurück', onb_next: 'Weiter', onb_done: 'Loslegen', show_intro: 'Begrüßung anzeigen',
