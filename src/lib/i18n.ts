...
const en: Dict = {
  ...
  onb_welcome_title: 'Welcome to Speed Dial', onb_welcome_body: 'A clean, private new tab — no ads, no tracking. Everything stays on your device.', onb_footer_title: 'Hide Chrome’s bottom bar', onb_footer_body: 'Chrome shows its own footer at the bottom of the page. To hide it: click “Customize Chrome” (bottom-right) → Footer → turn off “Show footer on New Tab page”.', onb_start_title: 'Make it yours', onb_start_body: 'Press + to add sites and widgets, use Edit to drag and resize, and open the ⚙ menu for themes and settings.', onb_skip: 'Skip', onb_back: 'Back', onb_next: 'Next', onb_done: 'Get started', show_intro: 'Show welcome guide',
...
const ru: Dict = {
  ...
  onb_welcome_title: 'Добро пожаловать в Speed Dial', onb_welcome_body: 'Чистая, приватная новая вкладка — без рекламы и слежки. Всё хранится на твоём устройстве.', onb_footer_title: 'Скрыть нижнюю панель Chrome', onb_footer_body: 'Chrome показывает свою панель внизу страницы. Чтобы убрать: нажми «Customize Chrome» (внизу справа) → Footer → выключи «Show footer on New Tab page».', onb_start_title: 'Сделай вкладку своей', onb_start_body: 'Жми +, чтобы добавлять сайты и виджеты, кнопкой «Править» двигай и меняй размер, а в меню ⚙ — темы и настройки.', onb_skip: 'Пропустить', onb_back: 'Назад', onb_next: 'Далее', onb_done: 'Начать', show_intro: 'Показать приветствие',
...
const es: Dict = {
  ...
  onb_welcome_title: 'Te damos la bienvenida a Speed Dial', onb_welcome_body: 'Una nueva pestaña limpia y privada: sin anuncios ni rastreo. Todo se queda en tu dispositivo.', onb_footer_title: 'Ocultar la barra inferior de Chrome', onb_footer_body: 'Chrome muestra su propia barra al final de la página. Para ocultarla: pulsa «Customize Chrome» (abajo a la derecha) → Footer → desactiva «Show footer on New Tab page».', onb_start_title: 'Hazla tuya', onb_start_body: 'Pulsa + para añadir sitios y widgets, usa Editar para mover y redimensionar, y abre el menú ⚙ para temas y ajustes.', onb_skip: 'Omitir', onb_back: 'Atrás', onb_next: 'Siguiente', onb_done: 'Empezar', show_intro: 'Mostrar la guía de bienvenida',
...
const de: Dict = {
  ...
  onb_welcome_title: 'Willkommen bei Speed Dial', onb_welcome_body: 'Ein sauberer, privater neuer Tab – keine Werbung, kein Tracking. Alles bleibt auf deinem Gerät.', onb_footer_title: 'Chrome-Leiste unten ausblenden', onb_footer_body: 'Chrome zeigt unten eine eigene Leiste. So blendest du sie aus: „Customize Chrome“ (unten rechts) → Footer → „Show footer on New Tab page“ deaktivieren.', onb_start_title: 'Mach ihn zu deinem', onb_start_body: 'Mit + fügst du Seiten und Widgets hinzu, mit „Bearbeiten“ verschiebst und skalierst du, und im ⚙-Menü findest du Designs und Einstellungen.', onb_skip: 'Überspringen', onb_back: 'Zurück', onb_next: 'Weiter', onb_done: 'Loslegen', show_intro: 'Begrüßung anzeigen',
...
const fr: Dict = {
  ...
  onb_welcome_title: 'Bienvenue dans Speed Dial', onb_welcome_body: 'Un nouvel onglet épuré et privé — sans pub ni pistage. Tout reste sur votre appareil.', onb_footer_title: 'Masquer la barre inférieure de Chrome', onb_footer_body: 'Chrome affiche sa propre barre en bas de la page. Pour la masquer : cliquez sur « Customize Chrome » (en bas à droite) → Footer → désactivez « Show footer on New Tab page ».', onb_start_title: 'Personnalisez-le', onb_start_body: 'Appuyez sur + pour ajouter des sites et widgets, utilisez Modifier pour déplacer et redimensionner, et ouvrez le menu ⚙ pour les thèmes et réglages.', onb_skip: 'Passer', onb_back: 'Retour', onb_next: 'Suivant', onb_done: 'Commencer', show_intro: 'Afficher le guide de bienvenue',
